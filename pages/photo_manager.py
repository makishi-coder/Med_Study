...
button_css = float_css_helper(width="1rem", left="2rem", bottom='3.5em', transition=0)
...
button_css3 = float_css_helper(width="2rem", right="6rem", bottom='3.5rem', transition=0)
...
button_css2 = float_css_helper(width="2rem", right="1.5rem", bottom='3.5rem', transition=0)
